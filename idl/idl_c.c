...
handle_t hApexBinding;


static const RPC_CLIENT_INTERFACE apex___RpcClientInterface =
    {
...
RPC_IF_HANDLE apex_v1_0_c_ifspec = (RPC_IF_HANDLE)& apex___RpcClientInterface;

extern const MIDL_STUB_DESC apex_StubDesc;

static RPC_BINDING_HANDLE apex__MIDL_AutoBindHandle;


void storeDoubleArray( 
    ...
    /* [out] */ unsigned long *arraySize)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&apex_StubDesc,
                  (PFORMAT_STRING) &idl__MIDL_ProcFormatString.Format[42],
                  ( unsigned char * )&name);
    
}


void retreiveDoubleArray( 
    /* [string][in] */ const unsigned char *name,
    /* [in] */ unsigned long arraySize,
    /* [size_is][out] */ double array[  ])
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&apex_StubDesc,
                  (PFORMAT_STRING) &idl__MIDL_ProcFormatString.Format[78],
                  ( unsigned char * )&name);
...
static const MIDL_STUB_DESC apex_StubDesc = 
    {
    (void *)& apex___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &hApexBinding,
    0,
